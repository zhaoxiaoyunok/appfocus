...
import com.af.model.AfCircle;
import com.af.model.AfPoint;
...
public class AfMathUtil{
   ...
   */
	 ...
	 * @return
	 */
    public static boolean pointOnCircle(AfPoint point,AfCircle c1,AfCircle c2){
    ...
    /**
 	 ...
 	 * @return
 	 */
     public static boolean pointOnCircle(AfPoint point,AfCircle c1,AfCircle c2,float offset){
     ...
     * @return
     */
    public static boolean pointInCircle(AfPoint point,AfCircle circle){
     ...
     * @return
     */
    public static double getDistance(AfPoint p1,AfPoint p2) {  
	 ...
	 * @return
	 */
	public static List<AfPoint> circleCrossoverPoint(AfCircle circle1,AfCircle circle2){
		List<AfPoint> pointList = new ArrayList<AfPoint>();
		//第一个圆的参数方程:
		// x = r1 * cosCita + x1
		// y = r1 * sinCita + y1
		...
		Set<AfPoint> pointSet = new HashSet<AfPoint>();
		AfPoint p1_1 = new AfPoint(x_1,y_1_1);
		if(pointOnCircle(p1_1,circle1,circle2)){
			pointSet.add(p1_1);
		}
		
		AfPoint p1_2 = new AfPoint(x_1,y_1_2);
		...
		AfPoint p2_1 = new AfPoint(x_2,y_2_1);
		if(pointOnCircle(p2_1,circle1,circle2)){
			pointSet.add(p2_1);
		}
		
		AfPoint p2_2 = new AfPoint(x_2,y_2_2);
		if(pointOnCircle(p2_2,circle1,circle2)){
			pointSet.add(p2_2);
		}
		for(Iterator<AfPoint> iter = pointSet.iterator();iter.hasNext();){   
			AfPoint point = (AfPoint)iter.next();   
			pointList.add(point);
        }  
		return pointList;
	}
