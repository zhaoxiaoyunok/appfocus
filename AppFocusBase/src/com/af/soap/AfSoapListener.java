 ...
 * 
 */
public abstract class AfSoapListener {
	...
	private class SoapResponderHandler extends Handler {
		...
		/** 响应消息监听. */
		private AfSoapListener listener;
		 ...
		 */
		public SoapResponderHandler(AfSoapListener listener) {
