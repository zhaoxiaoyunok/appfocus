...
public class AfExpandTabView extends LinearLayout implements OnDismissListener {
	...
	public AfExpandTabView(Context context) {
		super(context);
		init(context);
	}

	public AfExpandTabView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
