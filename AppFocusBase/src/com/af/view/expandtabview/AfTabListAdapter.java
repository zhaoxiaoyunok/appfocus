...
public class AfTabListAdapter extends ArrayAdapter<AfMenuItem> {

	private Context mContext;
	private List<AfMenuItem> mListData;
	...
	public AfTabListAdapter(Context context, List<AfMenuItem> listData,int selectedResId,int normalResId) {
