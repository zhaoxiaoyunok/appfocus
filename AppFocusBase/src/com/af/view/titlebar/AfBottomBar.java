 ...
 * 
 */
public class AfBottomBar extends LinearLayout {
	 ...
	 */
	public AfBottomBar(Context context, AttributeSet attrs) {
		super(context, attrs);
	 ...
	 * @param context the context
	 */
	public AfBottomBar(Context context) {
		super(context);
		ininBottomBar(context);
