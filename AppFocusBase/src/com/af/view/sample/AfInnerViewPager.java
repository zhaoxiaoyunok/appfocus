 ...
 * 
 */
public class AfInnerViewPager extends ViewPager {
	 ...
	 */
	public AfInnerViewPager(Context context) {
		super(context);
	 ...
	 */
	public AfInnerViewPager(Context context, AttributeSet attrs) {
		super(context, attrs);
		mGestureDetector = new GestureDetector(new YScrollDetector());
		setFadingEdgeLength(0);
	}
