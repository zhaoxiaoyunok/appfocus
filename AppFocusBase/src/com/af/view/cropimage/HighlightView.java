...
public class HighlightView {
     ...
     */
    private void init() {
        mResizeDrawableDiagonal = AfImageUtil.bitmapToDrawable(AfFileUtil.getBitmapFromSrc("image/crop_big.png"));
        mResizeDrawableDiagonal2 = AfImageUtil.bitmapToDrawable(AfFileUtil.getBitmapFromSrc("image/crop_small.png"));
    }
