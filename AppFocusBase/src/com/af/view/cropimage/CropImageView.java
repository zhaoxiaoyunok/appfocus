...
public class CropImageView extends CropViewBase {
     ...
     * @see com.af.view.cropimage.CropViewBase#onLayout(boolean, int, int, int, int)
     * @author: amsoft.cn
     * 
     */
    @Override
     ...
     * @see com.af.view.cropimage.CropViewBase#zoomTo(float, float, float)
     * @author: amsoft.cn
     * 
     */
    @Override
     ...
     *
     * @version v1.0
     * @see com.af.view.cropimage.CropViewBase#zoomIn()
     * @author: amsoft.cn
     * 
     */
    @Override
     ...
     *
     * @version v1.0
     * @see com.af.view.cropimage.CropViewBase#zoomOut()
     * @author: amsoft.cn
     * 
     */
    @Override
     ...
     * @see com.af.view.cropimage.CropViewBase#postTranslate(float, float)
     * @author: amsoft.cn
     * 
     */
    @Override
