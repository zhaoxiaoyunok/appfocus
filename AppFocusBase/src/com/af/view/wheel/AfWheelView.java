 ...
 * 
 */
public class AfWheelView extends View {
	...
	// Wheel Values
	/** The adapter. */
	private AfWheelAdapter adapter = null;
	 ...
	 */
	public AfWheelView(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * @param attrs the attrs
	 */
	public AfWheelView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initData(context);
	}
	 ...
	 * @param context the context
	 */
	public AfWheelView(Context context) {
		super(context);
		initData(context);
	}
	 ...
	 * @return the adapter
	 */
	public AfWheelAdapter getAdapter() {
		return adapter;
	}
	 ...
	 */
	public void setAdapter(AfWheelAdapter adapter) {
	...
	private int getMaxTextLength() {
		AfWheelAdapter adapter = getAdapter();
		if (adapter == null) {
			return 0;
		}
	...
	private int calculateLayoutWidth(int widthSize, int mode) {
		...
		if (maxLength > 0) {
			//一个字符宽度
			float textWidth = (int)AfGraphicUtil.getStringWidth("0", labelPaint);
			//不算lable的宽度
		...
		if (label != null && label.length() > 0) {
			labelWidth = (int)AfGraphicUtil.getStringWidth(label, labelPaint);
		}
	...
	public void setValueTextSize(int textSize) {
		this.valueTextSize = AfViewUtil.scaleTextValue(mContext, textSize);
	...
	public void setLabelTextSize(int labelTextSize) {
		this.labelTextSize = AfViewUtil.scaleTextValue(mContext, labelTextSize);
	}
	...
	public interface AbOnWheelScrollListener {
		 ...
		 */
		void onScrollingStarted(AfWheelView wheel);
		
		/**
		 * Callback method to be invoked when scrolling ended.
		 * @param wheel the wheel view whose state has changed.
		 */
		void onScrollingFinished(AfWheelView wheel);
	}
	...
	public interface AbOnWheelChangedListener {
		 ...
		 */
		void onChanged(AfWheelView wheel, int oldValue, int newValue);
	}
