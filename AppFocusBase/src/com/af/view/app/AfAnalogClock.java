 ...
 * 
 */
public class AfAnalogClock extends View {
	 ...
	 */
	public AfAnalogClock(Context context, Drawable dial, Drawable hourHand,
	...
	private void onTimeChanged() {
		...
		mChanged = true;
		AfLogUtil.d(AfAnalogClock.class, "时间改变:mHour:"+mHour+",mMinutes:"+mMinutes+",mSecond:"+mSecond);
