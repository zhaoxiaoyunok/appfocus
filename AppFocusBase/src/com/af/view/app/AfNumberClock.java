 ...
 * 
 */
public class AfNumberClock extends View {
	 ...
	 */
	public AfNumberClock(Context context, Drawable timeBg, Drawable timeColon,
	...
	private void onTimeChanged() {
		...
		mSecond =  AfStrUtil.strFormat2(String.valueOf(mCalendar.second));
