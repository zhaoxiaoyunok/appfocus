 ...
 * 
 */
public class AfFocusView extends LinearLayout implements OnFocusChangeListener{
     ...
     */
    public AfFocusView(Context context){
        this(context, null);
    }
     ...
     */
    public AfFocusView(Context context, AttributeSet attrs){
     ...
     */
    public AfFocusView(Context context, AttributeSet attrs, int defStyle){
        super(context, attrs);
