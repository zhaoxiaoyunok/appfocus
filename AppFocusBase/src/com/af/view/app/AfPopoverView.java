 ...
 * 
 */
public class AfPopoverView extends RelativeLayout implements OnTouchListener{
	...
	public static interface PopoverViewListener{
		 ...
		 */
		void popoverViewWillShow(AfPopoverView view);
		 ...
		 * @param view The whole popover view
		 */
		void popoverViewDidShow(AfPopoverView view);
		 ...
		 * @param view The whole popover view
		 */
		void popoverViewWillDismiss(AfPopoverView view);
		 ...
		 * @param view The whole popover view
		 */
		void popoverViewDidDismiss(AfPopoverView view);
	}
	 ...
	 */
	public AfPopoverView(Context context) {
		super(context);
		initPopoverView();
	}
	 ...
	 */
	public AfPopoverView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initPopoverView();
	}
	 ...
	 */
	public AfPopoverView(Context context, AttributeSet attrs, int defStyle) {
	...
	private void initArrow(Rect originRect, Integer arrowDirection){
		...
		if (arrowDirection == AfPopoverView.PopoverArrowDirectionUp){
		...
		else if (arrowDirection == AfPopoverView.PopoverArrowDirectionDown){
		...
		else if (arrowDirection == AfPopoverView.PopoverArrowDirectionLeft){
		...
		else if (arrowDirection == AfPopoverView.PopoverArrowDirectionRight){
	...
	private void addAvailableRects(Rect originRect, int arrowDirections){
		...
		if ((arrowDirections & AfPopoverView.PopoverArrowDirectionUp) != 0){
			possibleRects.put(AfPopoverView.PopoverArrowDirectionUp, getRectForArrowUp(originRect));
		}
		if ((arrowDirections & AfPopoverView.PopoverArrowDirectionDown) != 0){
			possibleRects.put(AfPopoverView.PopoverArrowDirectionDown, getRectForArrowDown(originRect));
		}
		if ((arrowDirections & AfPopoverView.PopoverArrowDirectionRight) != 0){
			possibleRects.put(AfPopoverView.PopoverArrowDirectionRight, getRectForArrowRight(originRect));
		}
		if ((arrowDirections & AfPopoverView.PopoverArrowDirectionLeft) != 0){
			possibleRects.put(AfPopoverView.PopoverArrowDirectionLeft, getRectForArrowLeft(originRect));
		}
	...
	public void showPopoverFromRectInViewGroup(ViewGroup group, Rect originRect, int arrowDirections, boolean animated){
		...
		popoverLayoutRect = AfPopoverView.getFrameForView(superview);
			...
			if (!isAnimating){
				...
				animation.setAnimationListener(new AnimationListener() {
					...
					public void onAnimationEnd(Animation animation) {
						...
						//Tell delegate we did show
						if (popoverViewListener != null)
							popoverViewListener.popoverViewDidShow(AfPopoverView.this);
					}
				});
	...
	public void dissmissPopover(boolean animated){
		...
		if (popoverViewListener != null)
			popoverViewListener.popoverViewWillDismiss(AfPopoverView.this);
		...
		if (!animated){
			...
			if (popoverViewListener != null)
				popoverViewListener.popoverViewDidDismiss(AfPopoverView.this);
		}
		else{
			...
			if (!isAnimating){
				...
				animation.setAnimationListener(new AnimationListener() {
					...
					public void onAnimationEnd(Animation animation) {
						...
						popoverView.removeAllViews();
						removeAllViews();
						AfPopoverView.this.superview.removeView(AfPopoverView.this);
						//End animation
						isAnimating = false;
						//Tell delegate we did dismiss
						if (popoverViewListener != null)
