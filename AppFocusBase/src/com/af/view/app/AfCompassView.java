 ...
 * 
 */
public class AfCompassView extends ImageView {
     ...
     */
    public AfCompassView(Context context) {
        this(context,null);
	 ...
	 */
	public AfCompassView(Context context, AttributeSet attrs) {
		super(context, attrs);
