...
/**
 * The listener interface for receiving afIocEvent events.
 * The class that is interested in processing a afIocEvent
 * event implements this interface, and the object created
 * with that class is registered with a component using the
 * component's <code>addAfIocEventListener<code> method. When
 * the afIocEvent event occurs, that object's appropriate
 * method is invoked.
 *
 * @see AfIocEventEvent
 */
public class AfIocEventListener implements OnClickListener, OnLongClickListener, OnItemClickListener, OnItemSelectedListener,OnItemLongClickListener {
