...
/**
 * The Class AfMultiColumnListView.
 */
public class AfMultiColumnListView extends ScrollView{
	...
	/**  Adapter. */
	private AfMultiColumnListAdapter mAdapter = null;
	
	/**  Adapter改变的监听器. */
	private AdapterDataSetObserver mDataSetObserver;
	
	/**  已加载的View. */
	private List<AfViewInfo> mItems = null;
	 ...
	 */
	public AfMultiColumnListView(Context context) {
		this(context,null);
	}
	 ...
	 */
	public AfMultiColumnListView(Context context, AttributeSet attrs) {
	 ...
	 */
	public AfMultiColumnListView(Context context, AttributeSet attrs, int defStyle) {
		...
		mItems = new ArrayList<AfViewInfo>();
	}
	 ...
	 * @return the adapter
	 */
	public AfMultiColumnListAdapter getAdapter() {
		return mAdapter;
	}
	 ...
	 */
	public void setAdapter(AfMultiColumnListAdapter adapter) {
    ...
    protected void layoutChildren() {
    	AfLogUtil.d(AfMultiColumnListView.class, "layoutChildren");
    	...
    	if(mAdapter != null){
    		...
    		for (int i = 0; i < mItemCount; i++) {
    			AfViewInfo viewInfo = mAdapter.getView(i, null, null);
    ...
    protected void addChildren() {
    	AfLogUtil.d(AfMultiColumnListView.class, "addChildren");
    	if(mAdapter != null){
	 ...
	 */
	private void findColumnToAdd(AfViewInfo viewInfo) {
	...
	public boolean checkVisibility(int position) {
		AfViewInfo viewInfo = mItems.get(position);
	...
	class AdapterDataSetObserver extends DataSetObserver {
		...
		public void onChanged() {
			AfLogUtil.d(AfMultiColumnListView.class, "onChanged");
			//判断是刷新还是添加
    		int count = mAdapter.getCount();
    		if(count > mItems.size()){
    			//添加
