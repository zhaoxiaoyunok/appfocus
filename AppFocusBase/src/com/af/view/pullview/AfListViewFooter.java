 ...
 * 
 */
public class AfListViewFooter extends LinearLayout {
	 ...
	 */
	public AfListViewFooter(Context context) {
		super(context);
		initView(context);
	}
	 ...
	 */
	public AfListViewFooter(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	...
	private void initView(Context context) {
		...
		footerView.setMinimumHeight(AfViewUtil.scaleValue(mContext,100));
		footerTextView = new TextView(context);  
		footerTextView.setGravity(Gravity.CENTER_VERTICAL);
		setTextColor(Color.rgb(107, 107, 107));
		AfViewUtil.setTextSize(footerTextView,30);
		
		AfViewUtil.setPadding(footerView, 0, 10, 0, 10);
		...
		layoutParamsWW.rightMargin = AfViewUtil.scaleValue(mContext, 10);
