...
public class ScatterChart extends XYChart {
   ...
   * @see com.af.view.chart.XYChart#setDatasetRenderer(com.af.view.chart.XYMultipleSeriesDataset, com.af.view.chart.XYMultipleSeriesRenderer)
   * @author: amsoft.cn
   * 
   */
   ...
   * @see com.af.view.chart.XYChart#clickableAreasForPoints(float[], double[], float, int, int)
   * @author: amsoft.cn
   * 
   */
  @Override
