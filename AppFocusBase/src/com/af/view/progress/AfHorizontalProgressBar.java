...
/**
 * The Class AfHorizontalProgressBar.
 */
@SuppressLint("DrawAllocation")
public class AfHorizontalProgressBar extends View {
	 ...
	 */
	public AfHorizontalProgressBar(Context context, AttributeSet attrs) {
		super(context, attrs);
		pathPaint  = new Paint();
		// 设置是否抗锯齿
