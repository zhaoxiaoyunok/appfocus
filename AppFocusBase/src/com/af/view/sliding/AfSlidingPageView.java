 ...
 * 
 */
public class AfSlidingPageView extends ViewGroup {
	
	/** 记录日志的标记. */
	private String TAG = AfSlidingPageView.class.getSimpleName();
	 ...
	 */
	public AfSlidingPageView(Context context) {
		super(context);
	 ...
	 */
	public AfSlidingPageView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
