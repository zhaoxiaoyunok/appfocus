...
/**
 * © 2015 lyyj.com
 * 名称：AfSlidingSmoothFixTabView.java 
 * 描述：滑动的tab,tab固定屏幕内.
 *
 * @author kaka
 * @version v1.0
 * 
 */
public class AfSlidingSmoothFixTabView extends LinearLayout {
	 ...
	 */
	public AfSlidingSmoothFixTabView(Context context, AttributeSet attrs) {
		super(context, attrs);
		...
		if(!(this.context instanceof FragmentActivity)){
			AfLogUtil.e(AfSlidingSmoothFixTabView.class, "构造AbSlidingSmoothTabView的参数context,必须是FragmentActivity的实例。");
		}
	...
	public void computeTabImg(int index){
        ...
        AfLogUtil.d(AfSlidingSmoothFixTabView.class, "old--startX:"+startX);
	...
	public void addItemView(String tabText,Fragment fragment){
		...
		//重新
		AfLogUtil.d(AfSlidingSmoothFixTabView.class, "addItemView finish");
		mFragmentPagerAdapter.notifyDataSetChanged();
		mViewPager.setCurrentItem(0);
		computeTabImg(0);
	}
