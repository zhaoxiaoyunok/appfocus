...
import com.af.adapter.AfViewPagerAdapter;
import com.af.util.AfFileUtil;
import com.af.view.sample.AfInnerViewPager;
...
public class AfSlidingPlayView extends LinearLayout {
	
	/** 上下文. */
	private Context context;

	/** 内部的ViewPager. */
	private AfInnerViewPager mViewPager;
	...
	/** 适配器. */
	private AfViewPagerAdapter mAbViewPagerAdapter = null;
	 ...
	 */
	public AfSlidingPlayView(Context context) {
		super(context);
		initView(context);
	}
	 ...
	 */
	public AfSlidingPlayView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}
	...
	public void initView(Context context){
		...
		mViewPager = new AfInnerViewPager(context);
		...
		displayImage = AfFileUtil.getBitmapFromSrc("image/play_display.png");
		hideImage = AfFileUtil.getBitmapFromSrc("image/play_hide.png");
		
		mListViews = new ArrayList<View>();
		mAbViewPagerAdapter = new AfViewPagerAdapter(context,mListViews);
