...
import com.af.view.sample.AfViewPager;
  
// TODO: Auto-generated Javadoc

/**
 * © 2015 lyyj.com
 * 名称：AfSlidingTabView.java 
 * 描述：滑动的tab.
 *
 * @author kaka
 * @version v1.0
 * 
 */
public class AfBottomTabView extends LinearLayout {
	...
	/** tab的列表. */
	private ArrayList<AfTabItemView> tabItemList = null;
	...
	private OnClickListener mTabClickListener = new OnClickListener() {
        public void onClick(View view) {
        	AfTabItemView tabView = (AfTabItemView)view;
	 ...
	 */
	public AfBottomTabView(Context context, AttributeSet attrs) {
		super(context, attrs);
		...
		//内容的View的适配
		mViewPager = new AfViewPager(context);
		...
		//定义Tab栏
  		tabItemList = new ArrayList<AfTabItemView>();
  		tabItemTextList = new ArrayList<String>();
  		tabItemDrawableList = new ArrayList<Drawable>();
		//要求必须是FragmentActivity的实例
		if(!(this.context instanceof FragmentActivity)){
			AfLogUtil.e(AfBottomTabView.class, "构造AbSlidingTabView的参数context,必须是FragmentActivity的实例。");
		}
		
		DisplayMetrics mDisplayMetrics = AfAppUtil.getDisplayMetrics(context);
    ...
    public void setCurrentItem(int index) {
        ...
        for (int i = 0; i < tabCount; i++) {
            final AfTabItemView child = (AfTabItemView)mTabLayout.getChildAt(i);
    ...
    private void addTab(String text, int index,Drawable top) {
    	...
    	AfTabItemView tabView = new AfTabItemView(this.context);
	...
	public void setTabPadding(int left, int top, int right, int bottom) {
		for(int i = 0;i<tabItemList.size();i++){
			AfTabItemView tabView = tabItemList.get(i);
