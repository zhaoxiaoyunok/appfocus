 ...
 * 
 */
public class AfTabItemView extends LinearLayout {
     ...
     */
    public AfTabItemView(Context context) {
		this(context,null);
	}
	 ...
	 */
	public AfTabItemView(Context context, AttributeSet attrs) {
        super(context, attrs);
	...
	public void setTabTextSize(int tabTextSize) {
		AfViewUtil.setTextSize(mTextView, tabTextSize);
	}
	...
	public void setTabCompoundDrawablesBounds(int left, int top, int right, int bottom) {
		leftBounds = AfViewUtil.scaleValue(mContext, left);
		topBounds = AfViewUtil.scaleValue(mContext, top);
		rightBounds = AfViewUtil.scaleValue(mContext, right);
		bottomBounds = AfViewUtil.scaleValue(mContext, bottom);
	}
