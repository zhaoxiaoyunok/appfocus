 ...
 */
@SuppressLint("NewApi")
public class AfSlidingTabView extends LinearLayout {
     ...
     */
    public AfSlidingTabView(Context context) {
        this(context, null);
    }
     ...
     */
    public AfSlidingTabView(Context context, AttributeSet attrs) {
        super(context, attrs);
     ...
     */
    public AfSlidingTabView(Fragment fragment) {
        ...
        initView();
  		if(VERSION.SDK_INT <= 17){	
  			AfLogUtil.e(AfSlidingTabView.class, "AbSlidingTabView(Fragment fragment) 要求最低SDK版本17");
  		    return;
  		}
    ...
    public void initView(){
    	this.setOrientation(LinearLayout.VERTICAL);
 		...
 		if(!(this.context instanceof FragmentActivity)){
 			AfLogUtil.e(AfSlidingTabView.class, "构造AbSlidingTabView的参数context,必须是FragmentActivity的实例。");
 		}
    }
