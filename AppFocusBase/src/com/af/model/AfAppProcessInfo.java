 ...
 * 
 */
public class AfAppProcessInfo implements Comparable<AfAppProcessInfo>{
	 ...
	 * @param uid the uid
	 */
	public AfAppProcessInfo(String processName, int pid, int uid) {
		super();
	 ...
	 */
	@Override
	public int compareTo(AfAppProcessInfo another) {
