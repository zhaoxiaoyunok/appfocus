 ...
 * 
 */
public class AfSampleDialogFragment extends DialogFragment {
	 ...
	 */
	public static AfSampleDialogFragment newInstance(int style, int theme) {
	 ...
	 * @return the ab sample dialog fragment
	 */
	public static AfSampleDialogFragment newInstance(int style, int theme,int gravity) {
		AfSampleDialogFragment f = new AfSampleDialogFragment();
