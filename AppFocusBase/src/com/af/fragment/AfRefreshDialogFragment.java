...
/**
 * © 2015 lyyj.com
 * 名称：AfRefreshDialogFragment.java 
 * 描述：弹出的刷新框
 *
 * @author kaka
 * @version v1.0
 * 
 */
public class AfRefreshDialogFragment extends AfDialogFragment {
	 ...
	 * argument.
	 */
	public static AfRefreshDialogFragment newInstance(int style, int theme) {
		//不用单例模式
		AfRefreshDialogFragment f = new AfRefreshDialogFragment();
