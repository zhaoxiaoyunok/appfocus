...
public class AfImageBaseCache implements AfImageCache {
	
	/** LruCache. */
	private static LruCache<String, Bitmap> mCache;
	
	/** AbImageCache 实例. */
	private static AfImageBaseCache mImageCache;

	/**
	 * 构造方法.
	 */
	public AfImageBaseCache() {
		super();
		int maxSize = AfAppConfig.MAX_CACHE_SIZE_INBYTES;
	 ...
	 * @return
	 */
	public static AfImageBaseCache getInstance() {
		if(mImageCache == null){
			mImageCache = new AfImageBaseCache();
		}
		return mImageCache;
	}
