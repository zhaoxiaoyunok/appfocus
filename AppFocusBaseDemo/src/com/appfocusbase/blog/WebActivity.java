 ...
 * @version 
 */
public class WebActivity extends AfActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //访问assets目录下的文件
        String url = "http://wenzhang.baidu.com/?tag=%E7%A9%BA%E9%97%B4";//Constant.BASEURL+"m";
