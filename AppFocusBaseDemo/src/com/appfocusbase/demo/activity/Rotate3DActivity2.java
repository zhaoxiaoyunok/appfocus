...
import com.af.view.app.AfRotate3dAnimation2;
...
public class Rotate3DActivity2 extends Activity {
    ...
    private AfRotate3dAnimation2 leftAnimation;   
    private AfRotate3dAnimation2 rightAnimation;
    ...
    public void initFirst(){   
        leftAnimation = new AfRotate3dAnimation2(0, -90, 0.0f, 0.0f, mCenterX, mCenterY);   
        rightAnimation = new AfRotate3dAnimation2(90, 0, 0.0f, 0.0f, mCenterX, mCenterY);   
    ...
    public void initSecond(){   
        leftAnimation = new AfRotate3dAnimation2(-90, 0, 0.0f, 0.0f, mCenterX, mCenterY);   
        rightAnimation = new AfRotate3dAnimation2(0, 90, 0.0f, 0.0f, mCenterX, mCenterY);   
        leftAnimation.setFillAfter(true);   
        leftAnimation.setDuration(1000);   
        rightAnimation.setFillAfter(true);   
        rightAnimation.setDuration(1000);   
    ...
    //B面转到A面所在位置
    public void B2A(AfRotate3dAnimation2 rightAnimation){
    ...
    //D面转到A面所在位置
    public void D2A(AfRotate3dAnimation2 leftAnimation){
    ...
    //A面转到D面所在位置
    public void A2D(AfRotate3dAnimation2 rightAnimation){
    	setContentView(R.layout.layout_front);
		layoutFront = (ViewGroup)findViewById(R.id.layout_front);
    ...
    //C面转到D面所在位置
    public void C2D(AfRotate3dAnimation2 leftAnimation){
    ...
    //C面转到B面所在位置
    public void C2B(AfRotate3dAnimation2 rightAnimation){
    	setContentView(R.layout.layout_back);
    	layoutBack = (ViewGroup)findViewById(R.id.layout_back);
    ...
    //A面转到B面所在位置
    public void A2B(AfRotate3dAnimation2 leftAnimation){
    	setContentView(R.layout.layout_front);
    	layoutFront = (ViewGroup)findViewById(R.id.layout_front);
    ...
    //D面转到C面所在位置
    public void D2C(AfRotate3dAnimation2 rightAnimation){
    	setContentView(R.layout.layout_left);
    	layoutLeft = (ViewGroup)findViewById(R.id.layout_left);
    ...
    //B面转到C面所在位置
    public void B2C(AfRotate3dAnimation2 leftAnimation){
    	setContentView(R.layout.layout_right);
    	layoutRight = (ViewGroup)findViewById(R.id.layout_right);
