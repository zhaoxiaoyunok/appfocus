...
public class ListNestViewPagerActivity extends AfActivity implements OnHeaderRefreshListener,OnFooterLoadListener{
	...
	private AfSlidingPlayView mSlidingPlayView = null;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAfTitleBar.setTitleText(R.string.list_pager_name);
        ...
        mSlidingPlayView = new AfSlidingPlayView(this);
		...
		mSlidingPlayView.setOnItemClickListener(new AfSlidingPlayView.AbOnItemClickListener() {
			...
			public void onClick(int position) {
				AfToastUtil.showToast(ListNestViewPagerActivity.this,"点击"+position);
			}
		});
        ...
        mSlidingPlayView.setOnPageChangeListener(new AfSlidingPlayView.AbOnChangeListener() {
			...
			public void onChange(int position) {
				AfToastUtil.showToast(ListNestViewPagerActivity.this,"改变"+position);
			}
		});
        
        mListView.setAdapter(myListViewAdapter);
        
        AfDialogUtil.showProgressDialog(ListNestViewPagerActivity.this,R.drawable.progress_circular,"正在查询...");
	...
	public void refreshTask(){
    	...
    	AfTaskItem item = new AfTaskItem();
    	item.setListener(new AfTaskListener() {

			@Override
			public void update() {
				AfDialogUtil.removeDialog(ListNestViewPagerActivity.this);
				list.clear();
        ...
        item.setListener(new AfTaskListener() {
			...
			public void get() {
	   		    try {
	   		    	...
	   		    	currentPage--;
	   		    	newList.clear();
	   		    	AfToastUtil.showToastInThread(ListNestViewPagerActivity.this,e.getMessage());
	   		    }
		  };
		});
