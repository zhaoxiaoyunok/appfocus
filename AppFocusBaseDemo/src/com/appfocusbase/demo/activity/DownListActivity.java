...
import com.appfocusbase.demo.adapter.MyExpandableListAdapter;
...
import com.appfocusbase.util.download.DownFileDao;

public class DownListActivity extends AfActivity{
	...
	private AfTaskPool mAbTaskPool = null;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setAfContentView(R.layout.down_list);
        ...
        mAbTaskPool = AfTaskPool.getInstance();
