...
import com.af.view.calendar.CalendarCell;
import com.af.view.calendar.CalendarView;
import com.af.view.titlebar.AfTitleBar;
import com.appfocusbase.R;

public class CalendarActivity extends AfActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setAfContentView(R.layout.calendar);
		...
		mCalendarView.setOnItemClickListener(new CalendarView.AbOnItemClickListener() {
			...
			public void onClick(int position) {
				...
				AfToastUtil.showToast(CalendarActivity.this,"点击了"+position+"值："+date);
			}
		});
		...
		for (int i = 1; i < 12; i++) {
			monthList.add(preYear + "-" + AfStrUtil.strFormat2(String.valueOf(i)));
		}
		
		for (int i = 1; i <= curMonth; i++) {
			monthList.add(curYear + "-" + AfStrUtil.strFormat2(String.valueOf(i)));
		}
