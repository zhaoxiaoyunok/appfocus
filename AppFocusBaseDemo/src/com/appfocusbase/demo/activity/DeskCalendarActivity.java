...
public class DeskCalendarActivity extends AfActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setAfContentView(R.layout.desk_calendar);
		...
		AfCalendar view = new AfCalendar(this, caleBg, caleDot, posYear, dYearArray,
