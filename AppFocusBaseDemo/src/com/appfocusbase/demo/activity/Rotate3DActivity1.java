...
import com.af.view.app.AfRotate3dAnimation;
...
public class Rotate3DActivity1 extends AfActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setAfContentView(R.layout.rotate3d1);
    ...
    private void applyRotation(int position, float start, float end) {
        ...
        final AfRotate3dAnimation rotation =
                new AfRotate3dAnimation(start, end, centerX, centerY, 310.0f, true);
