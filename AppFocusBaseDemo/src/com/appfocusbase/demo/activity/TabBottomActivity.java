...
import com.af.view.sliding.AfBottomTabView;
import com.af.view.titlebar.AfTitleBar;
import com.appfocusbase.R;

public class TabBottomActivity extends AfActivity {
	
	private AfBottomTabView mBottomTabView;
	private List<Drawable> tabDrawables = null;

	@Override
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setAfContentView(R.layout.tab_bottom);
		
		AfTitleBar mAfTitleBar = this.getTitleBar();
		mAfTitleBar.setTitleText(R.string.tab_bottom_name);
		...
		mBottomTabView = (AfBottomTabView) findViewById(R.id.mBottomTabView);
