...
import com.af.view.sliding.AfSlidingButton;
    ...
    */
    ...
    public View getView(int position, View convertView, ViewGroup parent){
          ...
          if(convertView == null){
			  ...
			  holder.itemsCheck = ((AfSlidingButton) convertView.findViewById(mTo[2])) ;
			  //设置标记
          ...
          holder.itemsCheck.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			...
			public void onCheckedChanged(CompoundButton arg0, boolean arg1) {
				AfToastUtil.showToast(mContext,"开关变化");
			}
		});
