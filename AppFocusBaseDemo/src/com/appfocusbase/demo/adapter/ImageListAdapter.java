...
import com.af.util.AfViewHolder;
...
public class ImageListAdapter extends BaseAdapter{
    ...
    */
    ...
    public View getView(int position, View convertView, ViewGroup parent){
          ...
          ImageView itemsIcon = AfViewHolder.get(convertView, mTo[0]);
          TextView itemsTitle = AfViewHolder.get(convertView, mTo[1]);
          TextView itemsText = AfViewHolder.get(convertView, mTo[2]);
          ...
          Ion.with(itemsIcon).placeholder(R.drawable.progress_loading2).resize(150,150).load(imageUrl);
          return convertView;
    }
