...
public class LeftMenuAdapter extends BaseExpandableListAdapter {
	...
	private ArrayList<ArrayList<AfMenuItem>> mChilds;
	private LayoutInflater mInflater = null;

	public LeftMenuAdapter(Context context, ArrayList<String> groupName,ArrayList<ArrayList<AfMenuItem>> childs ) {
		mContext = context;
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		AfMenuItem m = mChilds.get(groupPosition).get(childPosition);
