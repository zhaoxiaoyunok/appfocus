package com.appfocusbase.global;
...
public class MyApplication extends Application {
	...
	public void onCreate() {
		super.onCreate();
		mSharedPreferences = getSharedPreferences(AfAppConfig.SHARED_PATH,
	...
	private void initLoginParams() {
		SharedPreferences preferences = getSharedPreferences(
				AfAppConfig.SHARED_PATH, Context.MODE_PRIVATE);
	...
	public void updateLoginParams(User user) {
		...
		if (userPasswordRemember) {
			...
			editor.putString(Constant.USERNAMECOOKIE, user.getName());
