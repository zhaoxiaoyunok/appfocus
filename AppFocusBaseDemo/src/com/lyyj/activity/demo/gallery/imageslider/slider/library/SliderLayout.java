package com.lyyj.activity.demo.gallery.imageslider.slider.library;
...
import com.lyyj.activity.demo.gallery.imageslider.slider.library.Animations.BaseAnimationInterface;
import com.lyyj.activity.demo.gallery.imageslider.slider.library.Indicators.PagerIndicator;
import com.lyyj.activity.demo.gallery.imageslider.slider.library.SliderTypes.BaseSliderView;
import com.lyyj.activity.demo.gallery.imageslider.slider.library.Transformers.AccordionTransformer;
import com.lyyj.activity.demo.gallery.imageslider.slider.library.Transformers.BackgroundToForegroundTransformer;
import com.lyyj.activity.demo.gallery.imageslider.slider.library.Transformers.BaseTransformer;
import com.lyyj.activity.demo.gallery.imageslider.slider.library.Transformers.CubeInTransformer;
import com.lyyj.activity.demo.gallery.imageslider.slider.library.Transformers.DefaultTransformer;
import com.lyyj.activity.demo.gallery.imageslider.slider.library.Transformers.DepthPageTransformer;
import com.lyyj.activity.demo.gallery.imageslider.slider.library.Transformers.FadeTransformer;
import com.lyyj.activity.demo.gallery.imageslider.slider.library.Transformers.FlipHorizontalTransformer;
import com.lyyj.activity.demo.gallery.imageslider.slider.library.Transformers.FlipPageViewTransformer;
import com.lyyj.activity.demo.gallery.imageslider.slider.library.Transformers.ForegroundToBackgroundTransformer;
import com.lyyj.activity.demo.gallery.imageslider.slider.library.Transformers.RotateDownTransformer;
import com.lyyj.activity.demo.gallery.imageslider.slider.library.Transformers.RotateUpTransformer;
import com.lyyj.activity.demo.gallery.imageslider.slider.library.Transformers.StackTransformer;
import com.lyyj.activity.demo.gallery.imageslider.slider.library.Transformers.TabletTransformer;
import com.lyyj.activity.demo.gallery.imageslider.slider.library.Transformers.ZoomInTransformer;
import com.lyyj.activity.demo.gallery.imageslider.slider.library.Transformers.ZoomOutSlideTransformer;
import com.lyyj.activity.demo.gallery.imageslider.slider.library.Transformers.ZoomOutTransformer;
import com.lyyj.activity.demo.gallery.imageslider.slider.library.Tricks.FixedSpeedScroller;
import com.lyyj.activity.demo.gallery.imageslider.slider.library.Tricks.InfinitePagerAdapter;
import com.lyyj.activity.demo.gallery.imageslider.slider.library.Tricks.InfiniteViewPager;
import com.lyyj.activity.demo.gallery.imageslider.slider.library.Tricks.ViewPagerEx;
...
/**
 * SliderLayout is compound layout. This is combined with {@link com.lyyj.activity.demo.gallery.imageslider.slider.library.Indicators.PagerIndicator}
 * and {@link com.lyyj.activity.demo.gallery.imageslider.slider.library.Tricks.ViewPagerEx} .
 *
...
public class SliderLayout extends RelativeLayout{
    ...
    /**
     * {@link com.lyyj.activity.demo.gallery.imageslider.slider.library.Tricks.ViewPagerEx} indicator.
     */
    private PagerIndicator mIndicator;


    /**
     * A timer and a TimerTask using to cycle the {@link com.lyyj.activity.demo.gallery.imageslider.slider.library.Tricks.ViewPagerEx}.
     */
    private Timer mCycleTimer;
    private TimerTask mCycleTask;

    /**
     * For resuming the cycle, after user touch or click the {@link com.lyyj.activity.demo.gallery.imageslider.slider.library.Tricks.ViewPagerEx}.
     */
    private Timer mResumingTimer;
    private TimerTask mResumingTask;

    /**
     * If {@link com.lyyj.activity.demo.gallery.imageslider.slider.library.Tricks.ViewPagerEx} is Cycling
     */
    private boolean mCycling;

    /**
     * Determine if auto recover after user touch the {@link com.lyyj.activity.demo.gallery.imageslider.slider.library.Tricks.ViewPagerEx}
     */
    ...
    /**
     * {@link com.lyyj.activity.demo.gallery.imageslider.slider.library.Tricks.ViewPagerEx} transformer time span.
     */
    ...
    /**
     * Visibility of {@link com.lyyj.activity.demo.gallery.imageslider.slider.library.Indicators.PagerIndicator}
     */
    private PagerIndicator.IndicatorVisibility mIndicatorVisibility = PagerIndicator.IndicatorVisibility.Visible;

    /**
     * {@link com.lyyj.activity.demo.gallery.imageslider.slider.library.Tricks.ViewPagerEx} 's transformer
     */
    private BaseTransformer mViewPagerTransformer;

    /**
     * @see com.lyyj.activity.demo.gallery.imageslider.slider.library.Animations.BaseAnimationInterface
     */
    private BaseAnimationInterface mCustomAnimation;

    /**
     * {@link com.lyyj.activity.demo.gallery.imageslider.slider.library.Indicators.PagerIndicator} shape, rect or oval.
     */
    ...
    public SliderLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mContext = context;
        LayoutInflater.from(context).inflate(R.layout.lyyj_gallery_imageslider_image_slider_slider_layout, this, true);
     ...
     * {@link com.lyyj.activity.demo.gallery.imageslider.slider.library.Animations.BaseAnimationInterface},
     * and you can see a example in {@link com.lyyj.activity.demo.gallery.imageslider.slider.library.Animations.DescriptionAnimation}
     * @param animation
     */
    ...
    /**
     * get the {@link com.lyyj.activity.demo.gallery.imageslider.slider.library.Indicators.PagerIndicator} instance.
