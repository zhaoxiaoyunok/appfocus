package com.lyyj.activity.demo.gallery;
...
import com.lyyj.activity.demo.gallery.fancycoverflow.samples.FancyCoverFlowMainActivity;
import com.lyyj.activity.demo.gallery.imageslider.slider.demo.ImageSliderMainActivity;
import com.lyyj.activity.demo.gallery.multichoice.ImagePickerMultiChoiceMainActivity;
import com.lyyj.activity.demo.gallery.staggeredgridview.StaggeredGridViewActivity;
...
public class GallerySetsActivity extends AfActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setAfContentView(R.layout.lyyj_gallery_sets);
    	...
    	clss.add(StaggeredGridViewActivity.class);
      	clss.add(FancyCoverFlowMainActivity.class);
    	clss.add(ImagePickerMultiChoiceMainActivity.class);
    	clss.add(ImageSliderMainActivity.class);
