package com.lyyj.activity.demo.anim;
...
import com.lyyj.activity.demo.anim.filleffect.AnimFillEffectMainActivity;
...
import com.lyyj.activity.demo.animation.curl.CurlActivity;
...
public class AnimationSetsActivity extends AfActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setAfContentView(R.layout.lyyj_anim_sets);
    	...
    	clss.add(ListViewTransition3dActivity.class);
     	clss.add(AnimRadiationViewActivity.class);
    	clss.add(CurtainEffectActivity.class);
     	clss.add(AnimFillEffectMainActivity.class);
    	clss.add(CurlActivity.class);
