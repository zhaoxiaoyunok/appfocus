package com.lyyj.activity.demo.anim.listview3deffect;
 ...
 */
public class ListViewTransition3dActivity extends Activity implements
    ...
    private static final String[] PHOTOS_NAMES = new String[] {
            ...
            "Grand Canyon Pier 8",
            "Grand Canyon Pier 9",
            "Grand Canyon Pier 10"
    };

    // Resource identifiers for the photos we want to display
    private static final int[] PHOTOS_RESOURCES = new int[] {
            R.drawable.lyyj_lv3d_photo1,
            R.drawable.lyyj_lv3d_photo2,
            R.drawable.lyyj_lv3d_photo3,
            R.drawable.lyyj_lv3d_photo4,
            R.drawable.lyyj_lv3d_photo5,
            R.drawable.lyyj_lv3d_photo6,
            R.drawable.lyyj_lv3d_photo7,
            R.drawable.lyyj_lv3d_photo8,
            R.drawable.lyyj_lv3d_photo9,
            R.drawable.lyyj_lv3d_photo10
            };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lyyj_lv3d_animations_main_screen);
