...
public class AnimFillEffectFragmentDemo extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lyyj_anim_filleffect_activity_fragment);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        Intent intent = new Intent(AnimFillEffectFragmentDemo.this, AnimFillEffectMainActivity.class);
...
class FlowerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mConverView = LayoutInflater.from(getActivity()).inflate(R.layout.lyyj_anim_filleffect_view_fragment, null);
