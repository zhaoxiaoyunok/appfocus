package com.lyyj.activity.demo.anim.curtaineffect.view;
...
import com.lyyj.activity.demo.anim.curtaineffect.tools.BaseTools;
...
public class CurtainView extends RelativeLayout implements OnTouchListener{
	...
	private void init(Context context) {
		...
		final View view = LayoutInflater.from(mContext).inflate(R.layout.lyyj_anim_curtain_curtain, null);
