...
public class MultiChoiceWithIconAndPreviewGridMainActivity extends Activity implements OnItemClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.lyyj_lv_multichoicewithiconandpreviewgrid_contactlist);
		lvContact = (ListView) this.findViewById(R.id.ListView_catalog);
		adapter = new ContactAdapter(MultiChoiceWithIconAndPreviewGridMainActivity.this);
		...
		initCheckedList();
		checkedAdapter = new CheckedImgAdapter(MultiChoiceWithIconAndPreviewGridMainActivity.this, checkedList);
