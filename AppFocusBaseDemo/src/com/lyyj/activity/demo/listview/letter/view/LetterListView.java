...
public class LetterListView extends FrameLayout {
	...
	private void initListView(Context context) {
		...
		mListView = (ListView) inflater.inflate(R.layout.lyyj_lv_letter_letter_list_container, null, false);
		LayoutParams lp = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
		addView(mListView, lp);

		// TODO 这里添加字母列表,可以在这里对ListView进行一些你想要的设置
		mLetterListView = (ListView) inflater.inflate(R.layout.lyyj_lv_letter_letter_list_letter, null, false);
		...
		// TODO 这里对显示的字母进行设置
		mLetterTextView = (TextView) inflater.inflate(R.layout.lyyj_lv_letter_letter_list_position, null, false);
	...
	private void showLetter(String letter) {
		...
		mLetterhandler.sendEmptyMessageDelayed(MSG_HIDE_LETTER, 200);
	}
	...
	private class LetterAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			if (convertView == null) {
				...
				AbsListView.LayoutParams lp = new AbsListView.LayoutParams(AbsListView.LayoutParams.MATCH_PARENT, itemHeight);
