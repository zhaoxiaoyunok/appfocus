package com.lyyj.activity.demo.listview.arclistview;
...
public class ArcListViewMainActivity extends Activity {

    private ListView lv;
    private int[] images = new int[] { R.drawable.lyyj_lv_arclv_p1, R.drawable.lyyj_lv_arclv_p2, R.drawable.lyyj_lv_arclv_p3 };

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.lyyj_lv_arclv_activity_main);
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (convertView == null) {
                MatrixView m = (MatrixView)LayoutInflater.from(ArcListViewMainActivity.this).inflate(R.layout.lyyj_lv_arclv_view_list_item, null);
