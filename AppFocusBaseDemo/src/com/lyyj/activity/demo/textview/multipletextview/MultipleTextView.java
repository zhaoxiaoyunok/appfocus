...
public class MultipleTextView extends RelativeLayout {
	...
	public MultipleTextView(Context context, AttributeSet attrs) {
		...
		TypedArray array = context.obtainStyledAttributes(attrs,
				R.styleable.MyView);
		textColor = array.getColor(R.styleable.MyView_textColorMultiple, 0XFF00FF00); // 提供默认值，放置未指定
		textSize = array.getDimension(R.styleable.MyView_textSizeMultiple, 24);
		textSize=px2sp(context,textSize);
		wordMargin = array.getDimensionPixelSize(R.styleable.MyView_textWordMarginMultiple, 0);
		lineMargin = array.getDimensionPixelSize(R.styleable.MyView_textLineMarginMultiple, 0);
		textBackground = array.getDrawable(R.styleable.MyView_textBackgroundMultiple);
		textPaddingLeft = array.getDimensionPixelSize(R.styleable.MyView_textPaddingLeftMultiple, 0);
		textPaddingRight = array.getDimensionPixelSize(R.styleable.MyView_textPaddingRightMultiple, 0);
		textPaddingTop = array.getDimensionPixelSize(R.styleable.MyView_textPaddingTopMultiple, 0);
		textPaddingBottom = array.getDimensionPixelSize(R.styleable.MyView_textPaddingBottomMultiple, 0);
		array.recycle();
		//下边是获取系统属性
