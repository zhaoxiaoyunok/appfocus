package com.lyyj.activity.demo.textview.library;
...
public class MatchTextView extends MatchView {
    ...
    void initAttrs(AttributeSet attrs) {
        ...
        //获取尺寸属性值,默认大小为：25
        mTextSize = a.getDimension(R.styleable.match_mvtextSize, 25);
        //获取颜色属性值,默认颜色为：Color.WHITE
        mTextColor = a.getColor(R.styleable.match_mvtextColor, Color.WHITE);
        //获取内容
        mContent = a.getString(R.styleable.match_mvtext);
        init();
    }
