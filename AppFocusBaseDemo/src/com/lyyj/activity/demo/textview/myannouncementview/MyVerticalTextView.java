/**
 * MyVerticalTextView.java [V 1..0.0]
 * classes : com.eFan.zhangyx.MyAnnouncementView.view.MyVerticalTextView
 * zhangyx Create at 2014-11-5 下午1:56:09
 */
...
/**
 * 自定义 竖直方向的跑马灯
 * com.eFan.zhangyx.MyAnnouncementView.view.MyVerticalTextView
 * 
 * @author zhangyx
 * 
 *         create at 2014-11-5 下午1:56:09
 */
public class MyVerticalTextView extends TextView {
	...
	public MyVerticalTextView(Context context, AttributeSet attr) {
		super(context, attr);
		init();
	}

	public MyVerticalTextView(Context context, AttributeSet attr, int i) {
