 ...
 */
package com.lyyj.activity.demo.textview.babushkatext;
...
public class BabushkaTextActivity extends Activity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.lyyj_tv_babuskatext_activity_main);
