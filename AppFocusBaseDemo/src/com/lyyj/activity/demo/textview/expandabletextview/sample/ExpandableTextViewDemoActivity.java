package com.lyyj.activity.demo.textview.expandabletextview.sample;
...
import com.lyyj.activity.demo.textview.expandabletextview.ExpandableTextView;
...
public class ExpandableTextViewDemoActivity extends ActionBarActivity implements ActionBar.TabListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lyyj_tv_expandtextview_activity_demo);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.lyyj_tv_expandtextview_demo, menu);
        return true;
    }
    ...
    public static class Demo1Fragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.lyyj_tv_expandtextview_fragment_demo1, container, false);
