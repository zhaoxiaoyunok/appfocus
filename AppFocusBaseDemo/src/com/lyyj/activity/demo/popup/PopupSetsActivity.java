package com.lyyj.activity.demo.popup;
...
import com.lyyj.activity.demo.popup.bottom.PopupBottomDemoActivity;
import com.lyyj.activity.demo.popup.uc.PopupUCDemoActivity;
import com.lyyj.activity.demo.popup.weixin.PopupWeixinDemoActivity;
...
public class PopupSetsActivity extends AfActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setAfContentView(R.layout.lyyj_popup_sets);
    	...
    	clss.add(PopupUCDemoActivity.class);
      	clss.add(PopupWeixinDemoActivity.class);
    	clss.add(PopupBottomDemoActivity.class);
