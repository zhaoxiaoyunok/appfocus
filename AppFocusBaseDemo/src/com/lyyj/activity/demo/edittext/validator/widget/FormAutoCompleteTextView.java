...
public class FormAutoCompleteTextView extends AutoCompleteTextView {
     ...
     */
    public void addValidator(com.lyyj.activity.demo.edittext.validator.Validator theValidator) throws IllegalArgumentException {
     ...
     * customValidators and call {@link com.lyyj.activity.demo.edittext.validator.Validator#isValid(EditText)}
     *
