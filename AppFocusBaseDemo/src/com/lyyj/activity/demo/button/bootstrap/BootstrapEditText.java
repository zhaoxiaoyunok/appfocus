...
public class BootstrapEditText extends EditText {
    ...
    public enum TextState {
        ...
        DEFAULT("default", R.drawable.lyyj_btn_bootstrap_edittext_background_rounded, R.drawable.lyyj_btn_bootstrap_edittext_background),
        SUCCESS("success", R.drawable.lyyj_btn_bootstrap_edittext_background_rounded_success, R.drawable.lyyj_btn_bootstrap_edittext_background_success),
        WARNING("warning", R.drawable.lyyj_btn_bootstrap_edittext_background_rounded_warning, R.drawable.lyyj_btn_bootstrap_edittext_background_warning),
        DANGER("danger", R.drawable.lyyj_btn_bootstrap_edittext_background_rounded_danger, R.drawable.lyyj_btn_bootstrap_edittext_background_danger);
