package com.lyyj.activity.demo.button.bootstrap;
...
public class BootstrapButton extends FrameLayout {
    ...
    private enum BootstrapType {
        DEFAULT("default", R.drawable.lyyj_btn_bootstrap_bbuton_default, R.drawable.lyyj_btn_bootstrap_bbuton_default_rounded, R.color.black),
        PRIMARY("primary", R.drawable.lyyj_btn_bootstrap_bbuton_primary, R.drawable.lyyj_btn_bootstrap_bbuton_primary_rounded, R.color.white),
        SUCCESS("success", R.drawable.lyyj_btn_bootstrap_bbuton_success, R.drawable.lyyj_btn_bootstrap_bbuton_success_rounded, R.color.white),
        INFO("info", R.drawable.lyyj_btn_bootstrap_bbuton_info, R.drawable.lyyj_btn_bootstrap_bbuton_info_rounded, R.color.white),
        WARNING("warning", R.drawable.lyyj_btn_bootstrap_bbuton_warning, R.drawable.lyyj_btn_bootstrap_bbuton_warning_rounded, R.color.white),
        DANGER("danger", R.drawable.lyyj_btn_bootstrap_bbuton_danger, R.drawable.lyyj_btn_bootstrap_bbuton_danger_rounded, R.color.white),
        INVERSE("inverse", R.drawable.lyyj_btn_bootstrap_bbuton_inverse, R.drawable.lyyj_btn_bootstrap_bbuton_inverse_rounded, R.color.white);
    ...
    private void initialise(AttributeSet attrs) {
        ...
        View v = inflater.inflate(R.layout.lyyj_btn_bootstrap_button, this, false);
