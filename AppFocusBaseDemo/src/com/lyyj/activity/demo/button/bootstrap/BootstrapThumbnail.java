...
public class BootstrapThumbnail extends FrameLayout {
    ...
    private enum ThumbnailTypes {
        ROUNDED(R.drawable.lyyj_btn_bootstrap_bthumbnail_container_rounded, R.drawable.lyyj_btn_bootstrap_bthumbnail_placeholder_default),
        SQUARE(R.drawable.lyyj_btn_bootstrap_bthumbnail_container_square, R.drawable.lyyj_btn_bootstrap_bthumbnail_placeholder_default);
    ...
    private void initialise(AttributeSet attrs) {
        ...
        View v = inflater.inflate(R.layout.lyyj_btn_bootstrap_thumbnail, this, false);
