...
import com.lyyj.activity.demo.button.bootstrap.BootstrapButton;
import com.lyyj.activity.demo.button.bootstrap.BootstrapEditText;
import com.lyyj.activity.demo.button.bootstrap.FontAwesomeText;

public class BootstrapMainActivity extends Activity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.lyyj_btn_bootstrap_activity_main);
