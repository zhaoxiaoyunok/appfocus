...
import com.lyyj.activity.demo.button.bootstrap.utils.ImageUtils;
...
public class BootstrapCircleThumbnail extends FrameLayout {
    ...
    private void initialise(AttributeSet attrs) {
        ...
        View v = inflater.inflate(R.layout.lyyj_btn_bootstrap_thumbnail_circle, this, false);
        ...
        if (!this.minimal) {
            ...
            container.setBackgroundResource(R.drawable.lyyj_btn_bootstrap_thumbnail_circle_container);
        }
        else {
            container.setBackgroundResource(R.drawable.lyyj_btn_bootstrap_thumbnail_circle_minimal);
        }
        ...
        if (imageDrawable == 0) {
            ...
            placeholder.setBackgroundResource(R.drawable.lyyj_btn_bootstrap_thumbnail_circle);
