package com.lyyj.activity.demo.button.fancybuttons;
...
public class FancyButton  extends LinearLayout{
    ...
    private void initAttributsArray(TypedArray attrsArray){
        ...
        mDefaultBackgroundColor 		= attrsArray.getColor(R.styleable.FancyButtonsAttrs_defaultColorFancyButtons,mDefaultBackgroundColor);
        mFocusBackgroundColor 			= attrsArray.getColor(R.styleable.FancyButtonsAttrs_focusColorFancyButtons,mFocusBackgroundColor);

        mDefaultTextColor 				= attrsArray.getColor(R.styleable.FancyButtonsAttrs_textColorFancyButtons,mDefaultTextColor);
        // if default color is set then the icon's color is the same (the default for icon's color)
        mDefaultIconColor               = attrsArray.getColor(R.styleable.FancyButtonsAttrs_iconColorFancyButtons,mDefaultTextColor);
        mDefaultTextSize				= (int) attrsArray.getDimension(R.styleable.FancyButtonsAttrs_textSizeFancyButtons,mDefaultTextSize);
        mDefaultTextGravity             = attrsArray.getInt(R.styleable.FancyButtonsAttrs_textGravityFancyButtons, mDefaultTextGravity);

        mBorderColor 					= attrsArray.getColor(R.styleable.FancyButtonsAttrs_borderColorFancyButtons,mBorderColor);
        mBorderWidth					= (int) attrsArray.getDimension(R.styleable.FancyButtonsAttrs_borderWidthFancyButtons,mBorderWidth);
        
        mRadius 						= (int)attrsArray.getDimension(R.styleable.FancyButtonsAttrs_radiusFancyButtons,mRadius);
        mFontIconSize 					= (int)attrsArray.getDimension(R.styleable.FancyButtonsAttrs_fontIconSizeFancyButtons,mFontIconSize);

        mIconPaddingLeft                = (int)attrsArray.getDimension(R.styleable.FancyButtonsAttrs_iconPaddingLeftFancyButtons,mIconPaddingLeft);
        mIconPaddingRight               = (int)attrsArray.getDimension(R.styleable.FancyButtonsAttrs_iconPaddingRightFancyButtons,mIconPaddingRight);
        mIconPaddingTop                 = (int)attrsArray.getDimension(R.styleable.FancyButtonsAttrs_iconPaddingTopFancyButtons,mIconPaddingTop);
        mIconPaddingBottom              = (int)attrsArray.getDimension(R.styleable.FancyButtonsAttrs_iconPaddingBottomFancyButtons,mIconPaddingBottom);

        String text 					= attrsArray.getString(R.styleable.FancyButtonsAttrs_textFancyButtons);
        mIconPosition 					= attrsArray.getInt(R.styleable.FancyButtonsAttrs_iconPositionFancyButtons,mIconPosition);

        String fontIcon 				= attrsArray.getString(R.styleable.FancyButtonsAttrs_fontIconResourceFancyButtons);

        String iconFontFamily 			= attrsArray.getString(R.styleable.FancyButtonsAttrs_iconFontFancyButtons);
        String textFontFamily 			= attrsArray.getString(R.styleable.FancyButtonsAttrs_textFontFancyButtons);

        Drawable icon = null;
        try{
            mIconResource 				= attrsArray.getDrawable(R.styleable.FancyButtonsAttrs_iconResourceFancyButtons);
