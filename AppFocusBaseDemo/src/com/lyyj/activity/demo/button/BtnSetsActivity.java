package com.lyyj.activity.demo.button;
...
import com.lyyj.activity.demo.button.bootstrap.BootstrapMainActivity;
import com.lyyj.activity.demo.button.circlebutton.CircleButtonMainActivity;
import com.lyyj.activity.demo.button.fabbutton.FabButtonMainActivity;
import com.lyyj.activity.demo.button.fancybuttons.samples.FancyButtonsMainActivity;
import com.lyyj.activity.demo.button.processbutton.sample.ProcessButtonMainActivity;
import com.lyyj.activity.demo.button.rippleview.RippleViewActivity;
...
public class BtnSetsActivity extends AfActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setAfContentView(R.layout.lyyj_btn_sets);
    	...
    	clss.add(SegmentedRadioActivity.class);
     	clss.add(BootstrapMainActivity.class);
    	clss.add(FabButtonMainActivity.class);
    	clss.add(FancyButtonsMainActivity.class);
     	clss.add(ProcessButtonMainActivity.class);
     	clss.add(CircleButtonMainActivity.class);
     	clss.add(RippleViewActivity.class);
    } 
