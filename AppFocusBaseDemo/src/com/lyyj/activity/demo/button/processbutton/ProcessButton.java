package com.lyyj.activity.demo.button.processbutton;
...
public abstract class ProcessButton extends FlatButton {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mProgressDrawable = (GradientDrawable) getDrawable(R.drawable.lyyj_btn_processbtn_rect_progress).mutate();
        mProgressDrawable.setCornerRadius(getCornerRadius());

        mCompleteDrawable = (GradientDrawable) getDrawable(R.drawable.lyyj_btn_processbtn_rect_complete).mutate();
        mCompleteDrawable.setCornerRadius(getCornerRadius());

        mErrorDrawable = (GradientDrawable) getDrawable(R.drawable.lyyj_btn_processbtn_rect_error).mutate();
    ...
    /**
     * A {@link android.os.Parcelable} representing the {@link com.lyyj.activity.demo.button.processbutton.ProcessButton}'s
     * state.
     */
