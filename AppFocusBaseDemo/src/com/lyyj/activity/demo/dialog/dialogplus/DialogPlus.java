...
public class DialogPlus {
    ...
    private DialogPlus(Builder builder) {
        ...
        rootView = (ViewGroup) inflater.inflate(R.layout.lyyj_dialog_plus_lib_base_container, null);
    ...
    private int getAnimationResource(Gravity gravity, boolean isInAnimation) {
        switch (gravity) {
            case TOP:
                return isInAnimation ? R.anim.lyyj_dialog_plus_lib_slide_in_top : R.anim.lyyj_dialog_plus_lib_slide_out_top;
            case BOTTOM:
                return isInAnimation ? R.anim.lyyj_dialog_plus_lib_slide_in_bottom : R.anim.lyyj_dialog_plus_lib_slide_out_bottom;
            case CENTER:
                return isInAnimation ? R.anim.lyyj_dialog_plus_lib_fade_in_center : R.anim.lyyj_dialog_plus_lib_fade_out_center;
            default:
