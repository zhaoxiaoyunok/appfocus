package com.lyyj.activity.demo.dialog.dialogmultichoice;
 ...
 *
 */
public class DialogMultiChoiceMainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.lyyj_dialog_multichoice_activity_main);
	}
	...
	class PositiveClickListener implements OnClickListener {
		...
		public void onClick(DialogInterface dialog, int which) {
			...
			alert(DialogMultiChoiceMainActivity.this, s);
		}
	}
