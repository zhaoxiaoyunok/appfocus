package com.lyyj.activity.demo.dialog;
...
import com.lyyj.activity.demo.anim.curtaineffect.CurtainEffectActivity;
...
import com.lyyj.activity.demo.dialog.dialogmultichoice.DialogMultiChoiceMainActivity;
import com.lyyj.activity.demo.dialog.dialogplus.sample.DialogPlusActivity;
import com.lyyj.activity.demo.dialog.frameanimation.RuningManActivity;
...
public class DialogSetsActivity extends AfActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setAfContentView(R.layout.lyyj_dialog_sets);
        
        AfTitleBar mAfTitleBar = this.getTitleBar();
        mAfTitleBar.setTitleText("dialog合集");
    	...
    	clss.add(DialogPlusActivity.class);
     	clss.add(DialogMultiChoiceMainActivity.class);
     	clss.add(RuningManActivity.class);
