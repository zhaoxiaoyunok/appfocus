package com.lyyj.activity.demo.imageprocess;
...
import com.lyyj.activity.demo.imageprocess.facecropper.sample.FaceCropperActivity;
import com.lyyj.activity.demo.imageprocess.opallinone.ImageActivity;
import com.lyyj.activity.demo.imageprocess.stackblur.StackBlurMainActivity;
...
public class ImageProcessSetsActivity extends AfActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setAfContentView(R.layout.lyyj_imageprocess_sets);
        ...
        clss.add(StackBlurMainActivity.class);
    	clss.add(FaceCropperActivity.class);
    	clss.add(ImageActivity.class);
     	clss.add(StackBlurMainActivity.class);
