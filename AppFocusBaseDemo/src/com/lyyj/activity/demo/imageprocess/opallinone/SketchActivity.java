...
public class SketchActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lyyj_imageprocess_opallinone_sketch);
	...
	private void cancelSketch() {
		Bitmap bmp = BitmapFactory.decodeStream(getResources().openRawResource(R.drawable.lyyj_imageprocess_opallinone_image));
