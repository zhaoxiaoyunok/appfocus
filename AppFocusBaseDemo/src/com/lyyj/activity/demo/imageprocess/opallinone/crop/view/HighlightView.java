package com.lyyj.activity.demo.imageprocess.opallinone.crop.view;
...
public class HighlightView {
    ...
    private void init() {
        ...
        mResizeDrawableWidth = resources.getDrawable(R.drawable.lyyj_imageprocess_opallinone_camera_crop_width);
        mResizeDrawableHeight = resources.getDrawable(R.drawable.lyyj_imageprocess_opallinone_camera_crop_height);
        mResizeDrawableDiagonal = resources.getDrawable(R.drawable.lyyj_imageprocess_opallinone_indicator_autocrop);
    }
