package com.lyyj.activity.demo.expandlistview.slideexpandable.sample;
...
import com.lyyj.activity.demo.expandlistview.slideexpandable.library.ActionSlideExpandableListView;
import com.lyyj.activity.demo.expandlistview.slideexpandable.library.SlideExpandableListAdapter;
 ...
 */
public class SlideExpandListViewExampleActivity extends Activity {
	...
	public void onCreate(Bundle savedData) {
		...
		this.setContentView(R.layout.lyyj_expandlv_expandable_single_expandable_list);
		...
		list.setItemActionListener(new ActionSlideExpandableListView.OnActionClickListener() {
			...
			public void onClick(View listView, View buttonview, int position) {
				 ...
				 */
				Toast.makeText(
					SlideExpandListViewExampleActivity.this,
	...
	public ListAdapter buildDummyData() {
		...
		return new ArrayAdapter<String>(
				this,
				R.layout.lyyj_expandlv_expandable_list_item,
				R.id.text,
				values
		);
	}
