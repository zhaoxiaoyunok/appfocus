package com.lyyj.activity.demo.expandlistview;
...
import com.lyyj.activity.demo.expandlistview.iphonetreeview.IphoneTreeViewMainActivity;
import com.lyyj.activity.demo.expandlistview.slideexpandable.sample.SlideExpandListViewExampleActivity;
import com.lyyj.activity.demo.expandlistview.timelinestory.TimeLineStoryMainActivity;
import com.lyyj.activity.demo.expandlistview.unlimitedtree.TreeActivity;
...
public class ExpandListViewSetsActivity extends AfActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setAfContentView(R.layout.lyyj_expandlv_sets);
    	...
    	clss.add(ExpandListViewGridViewActivity.class);
      	clss.add(SlideExpandListViewExampleActivity.class);
    	clss.add(TreeActivity.class);
     	clss.add(TimeLineStoryMainActivity.class);
    	clss.add(IphoneTreeViewMainActivity.class);
