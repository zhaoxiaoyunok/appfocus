package com.lyyj.activity.demo.expandlistview.timelinestory;
...
public class StatusExpandAdapter extends BaseExpandableListAdapter {
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		if (convertView == null) {
			convertView = inflater.inflate(R.layout.lyyj_expandlv_timelinestory_group_status_item, null);
		}
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		if (convertView != null) {
			...
			convertView = inflater.inflate(R.layout.lyyj_expandlv_timelinestory_child_status_item, null);
