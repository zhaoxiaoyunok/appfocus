package com.lyyj.activity.demo.expandlistview.iphonetreeview;
...
import com.lyyj.activity.demo.expandlistview.iphonetreeview.IphoneTreeView.IphoneTreeHeaderAdapter;


@SuppressLint("UseSparseArrays")
public class IphoneTreeViewMainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.lyyj_expandlv_iphonetreeview_activity_main);
		initView();
	}
	...
	private void initView() {
		...
		iphoneTreeView.setHeaderView(getLayoutInflater().inflate(
				R.layout.lyyj_expandlv_iphonetreeview_list_head_view, iphoneTreeView, false));
	...
	public class IphoneTreeViewAdapter extends BaseExpandableListAdapter
		...
		public View getChildView(int groupPosition, int childPosition,
			...
			// TODO Auto-generated method stub
			if (convertView == null) {
				convertView = mInflater.inflate(R.layout.lyyj_expandlv_iphonetreeview_list_item_view, null);
			}
		...
		public View getGroupView(int groupPosition, boolean isExpanded,
			...
			// TODO Auto-generated method stub
			if (convertView == null) {
				convertView = mInflater.inflate(R.layout.lyyj_expandlv_iphonetreeview_list_group_view, null);
			}
			...
			if (isExpanded) {
				indicator.setImageResource(R.drawable.lyyj_expandlv_iphonetreeview_indicator_expanded);
			} else {
				indicator.setImageResource(R.drawable.lyyj_expandlv_iphonetreeview_indicator_unexpanded);
			}
			return convertView;
		}
