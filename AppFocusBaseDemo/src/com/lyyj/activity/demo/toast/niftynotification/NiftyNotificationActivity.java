package com.lyyj.activity.demo.toast.niftynotification;
...
public class NiftyNotificationActivity extends AfActivity {
    private Effects effect;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setAfContentView(R.layout.lyyj_toast_niftynotification_activity_main);
    ...
    public void showNotify(View v){
        ...
        NiftyNotificationView.build(this,msg, effect,R.id.mLyout)
                .setIcon(R.drawable.lyyj_toast_niftynotification_lion)         //You must call this method if you use ThumbSlider effect
                .show();
