...
public class Time2Activity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lyyj_specialview_wheel_time2_layout);
    
        final WheelView hours = (WheelView) findViewById(R.id.hour);
        NumericWheelAdapter hourAdapter = new NumericWheelAdapter(this, 0, 23);
        hourAdapter.setItemResource(R.layout.lyyj_specialview_wheel_wheel_text_item);
        hourAdapter.setItemTextResource(R.id.text);
        hours.setViewAdapter(hourAdapter);
    
        final WheelView mins = (WheelView) findViewById(R.id.mins);
        NumericWheelAdapter minAdapter = new NumericWheelAdapter(this, 0, 59, "%02d");
        minAdapter.setItemResource(R.layout.lyyj_specialview_wheel_wheel_text_item);
        ...
        ampmAdapter.setItemResource(R.layout.lyyj_specialview_wheel_wheel_text_item);
    ...
    private class DayArrayAdapter extends AbstractWheelTextAdapter {
        ...
        protected DayArrayAdapter(Context context, Calendar calendar) {
            super(context, R.layout.lyyj_specialview_wheel_time2_day, NO_RESOURCE);
