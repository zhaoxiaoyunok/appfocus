...
import com.lyyj.activity.demo.specialview.wheel.widget.OnWheelScrollListener;
import com.lyyj.activity.demo.specialview.wheel.widget.WheelView;
import com.lyyj.activity.demo.specialview.wheel.widget.adapters.AbstractWheelTextAdapter;
...
public class CitiesActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.lyyj_specialview_wheel_cities_layout);
	...
	private class CountryAdapter extends AbstractWheelTextAdapter {
		...
		private String countries[] = new String[] { "USA", "Canada", "Ukraine",
				"France" };
		// Countries flags
		private int flags[] = new int[] { R.drawable.lyyj_specialview_wheel_usa, R.drawable.lyyj_specialview_wheel_canada,
				R.drawable.lyyj_specialview_wheel_ukraine, R.drawable.lyyj_specialview_wheel_france };

		/**
		 * Constructor
		 */
		protected CountryAdapter(Context context) {
			super(context, R.layout.lyyj_specialview_wheel_country_layout, NO_RESOURCE);
