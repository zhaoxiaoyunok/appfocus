package com.lyyj.activity.demo.specialview.cardsui.views;
...
import com.lyyj.activity.demo.specialview.cardsui.objects.AbstractCard;
...
public class CardUI extends FrameLayout {
	...
	private void initData(Context context) {
		...
		if (mColumnNumber == 1) {
			inflater.inflate(R.layout.lyyj_specialview_cardsui_cards_layout_lib_cards_view, this);
			// init observable scrollview
			mListView = (QuickReturnListView) findViewById(R.id.listView);
		} else {
			//initialize the mulitcolumn view
			inflater.inflate(R.layout.lyyj_specialview_cardsui_cards_layout_lib_cards_view_multicolumn, this);
			mTableLayout = (TableLayout) findViewById(R.id.tableLayout);
		}
		// mListView.setCallbacks(this);

		mHeader = inflater.inflate(R.layout.lyyj_specialview_cardsui_cards_layout_lib_header, null);
