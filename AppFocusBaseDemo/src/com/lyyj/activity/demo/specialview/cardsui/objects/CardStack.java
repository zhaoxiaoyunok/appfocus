package com.lyyj.activity.demo.specialview.cardsui.objects;
...
import com.lyyj.activity.demo.specialview.cardsui.StackAdapter;
import com.lyyj.activity.demo.specialview.cardsui.SwipeDismissTouchListener;
import com.lyyj.activity.demo.specialview.cardsui.Utils;
import com.lyyj.activity.demo.specialview.cardsui.SwipeDismissTouchListener.OnDismissCallback;
...
public class CardStack extends AbstractCard {
	...
	public View getView(Context context, boolean swipable) {
		...
		final View view = LayoutInflater.from(context).inflate(
				R.layout.lyyj_specialview_cardsui_cards_layout_lib_item_stack, null);
		...
		return new AnimatorListener() {
			...
			public void onAnimationStart(Animator animation) {
				if (index == 0) {
					...
					clickedCard
							.setBackgroundResource(R.drawable.lyyj_specialview_cardsui_cards_layout_lib_card_background);
				}
