...
public abstract class Card extends AbstractCard {
	...
	protected int getCardLayout() {
		return R.layout.lyyj_specialview_cardsui_cards_layout_lib_item_card_empty;
	}

	protected int getLastCardLayout() {
		return R.layout.lyyj_specialview_cardsui_cards_layout_lib_item_card_empty_last;
	}

	protected int getFirstCardLayout() {
		return R.layout.lyyj_specialview_cardsui_cards_layout_lib_item_card_empty_first;
	}
