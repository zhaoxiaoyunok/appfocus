...
package com.lyyj.activity.demo.specialview.pathmenuclockview.ui.adapters;
...
import com.lyyj.activity.demo.specialview.pathmenuclockview.ui.views.CircularImage;
import com.lyyj.activity.demo.specialview.pathmenuclockview.ui.views.RoundedCornersImage;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null || (holder = (ViewHolder) convertView.getTag()).flag != position) {
            ...
            if (position == 0) {
                ...
                convertView = LayoutInflater.from(context).inflate(R.layout.lyyj_specialview_pathmenuclockview_mixed_feed_cover_row,
                        null);
                ImageView cover = (ImageView) convertView.findViewById(R.id.cover_image);
                cover.setImageResource(R.drawable.lyyj_specialview_pathmenuclockview_cover);
                CircularImage avatar = (CircularImage) convertView
                        .findViewById(R.id.cover_user_photo);
                avatar.setImageResource(R.drawable.lyyj_specialview_pathmenuclockview_gauss0);

                RoundedCornersImage friend = (RoundedCornersImage) convertView
                        .findViewById(R.id.cover_requests_photo);
                friend.setImageResource(R.drawable.lyyj_specialview_pathmenuclockview_andrew0);
                ...
                convertView = LayoutInflater.from(context).inflate(
                        R.layout.lyyj_specialview_pathmenuclockview_mixed_feed_activity_item, null);
                ...
                if (ActivityMessage.MESSAGE_TYPE_TEXT == type) {
                    ...
                    View view = LayoutInflater.from(context).inflate(
                            R.layout.lyyj_specialview_pathmenuclockview_moment_thought_partial, null);
                ...
                // Img
                    ...
                    View view = LayoutInflater.from(context).inflate(R.layout.lyyj_specialview_pathmenuclockview_moment_photo_partial,
                            null);
                    feed_post_type.setImageResource(R.drawable.lyyj_specialview_pathmenuclockview_moment_icn_place);
                    // photo
                ...
                // Friend
                    ...
                    big.setVisibility(View.VISIBLE);
                    View view = LayoutInflater.from(context).inflate(
                            R.layout.lyyj_specialview_pathmenuclockview_moment_people_partial, null);
                    imgType.setImageResource(R.drawable.lyyj_specialview_pathmenuclockview_m_san);
