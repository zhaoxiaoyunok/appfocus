...
package com.lyyj.activity.demo.specialview.pathmenuclockview.ui.views;
...
public class CopyOfExtendedListView extends ListView implements OnScrollListener {
    ...
    public CopyOfExtendedListView(Context context, AttributeSet attrs, int defStyle) {
        ...
        final int scrollBarPanelInAnimation = a.getResourceId(
                R.styleable.ExtendedListView_scrollBarPanelInAnimation, R.anim.lyyj_specialview_pathmenuclockview_in_animation);
        final int scrollBarPanelOutAnimation = a.getResourceId(
                R.styleable.ExtendedListView_scrollBarPanelOutAnimation, R.anim.lyyj_specialview_pathmenuclockview_out_animation);
        a.recycle();
