package com.lyyj.activity.demo.specialview.pathmenuclockview.dto;
...
public class ActivityMessage {
	 ...
	 * @param body
	 */
	public ActivityMessage(int authorAvatar, String authorName,
			String storeName, String body, long realtime) {
		this.type = 1;
	 ...
	 */
	public ActivityMessage(int authorAvatar, String authorName,
			String storeName, String body, int storeimg, long realtime) {
	 ...
	 */
	public ActivityMessage(int authorAvatar, String authorName,
			String friendName, int friendImg, long realtime) {
