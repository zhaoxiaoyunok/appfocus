...
import com.lyyj.activity.demo.specialview.jellyviewpager.widget.JellyViewPager;

public class JellyViewPagerMainActivity extends FragmentActivity {
	JellyViewPager pager;
	int currentItem;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.lyyj_specialview_jellyviewpager_activity_main);
