package com.lyyj.activity.demo.gridview.horizontal.adapter;
...
import com.lyyj.activity.demo.gridview.horizontal.widget.ScrollLayout.SAdapter;
...
public class ScrollAdapter implements SAdapter {
	...
	public View getView(int position) {
		...
		if (position < mList.size()) {
			...
			view = mInflater.inflate(R.layout.lyyj_gridview_horizontal_item, null);
