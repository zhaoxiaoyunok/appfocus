...
public class DragAdapter extends BaseAdapter implements DragGridBaseAdapter{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		convertView = mInflater.inflate(R.layout.lyyj_gridview_gapps_grid_item, null);
		...
		ResolveInfo info =(ResolveInfo) list.get(position).get("item_resolve_info");
		mImageView.setImageDrawable((Drawable)info.loadIcon(mContext.getPackageManager()));
		mTextView.setText((CharSequence)info.loadLabel(mContext.getPackageManager()));
