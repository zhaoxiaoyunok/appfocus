...
public class SemiCircularRadialMenuActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.radial_menu_activity_semi_circular_radial_menu);
		
		mCamera = new SemiCircularRadialMenuItem("camera", getResources().getDrawable(R.drawable.radial_menu_ic_action_camera), "Camera");
		mDislike = new SemiCircularRadialMenuItem("dislike", getResources().getDrawable(R.drawable.radial_menu_ic_action_dislike), "Dislike");
		mInfo = new SemiCircularRadialMenuItem("info", getResources().getDrawable(R.drawable.radial_menu_ic_action_info), "Info");
		mRefresh = new SemiCircularRadialMenuItem("refresh", getResources().getDrawable(R.drawable.radial_menu_ic_action_refresh), "Refresh");
		mSearch = new SemiCircularRadialMenuItem("search", getResources().getDrawable(R.drawable.radial_menu_ic_action_search), "Search");
