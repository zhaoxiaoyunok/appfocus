...
public class MenuAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (item instanceof Category) {
            if (v == null) {
                v = LayoutInflater.from(mContext).inflate(R.layout.lyyj_menu_menudrawer_menu_row_category, parent, false);
            }
            ...
            if (v == null) {
                v = LayoutInflater.from(mContext).inflate(R.layout.lyyj_menu_menudrawer_menu_row_item, parent, false);
            }
