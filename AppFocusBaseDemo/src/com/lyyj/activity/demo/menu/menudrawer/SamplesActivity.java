    ...
    public class SamplesAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (getItemViewType(position) == 0) {
                ...
                if (v == null) {
                    v = (TextView) getLayoutInflater().inflate(R.layout.lyyj_menu_menudrawer_list_row_sample_header, parent, false);
                }
                ...
                View v = convertView;
                if (v == null) {
                    v = getLayoutInflater().inflate(R.layout.lyyj_menu_menudrawer_list_row_sample, parent, false);
                }
