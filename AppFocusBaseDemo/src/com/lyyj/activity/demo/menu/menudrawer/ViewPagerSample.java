...
public class ViewPagerSample extends BaseListSample {
    ...
    protected void onCreate(Bundle inState) {
        ...
        mMenuDrawer.setContentView(R.layout.lyyj_menu_menudrawer_activity_viewpagersample);
        mMenuDrawer.setSlideDrawable(R.drawable.lyyj_menu_menudrawer_ic_drawer);
