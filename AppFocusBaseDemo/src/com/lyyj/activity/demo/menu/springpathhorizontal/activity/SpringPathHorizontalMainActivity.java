package com.lyyj.activity.demo.menu.springpathhorizontal.activity;

import com.appfocusbase.R;
import com.lyyj.activity.demo.menu.springpathhorizontal.animation.EnlargeAnimationOut;
import com.lyyj.activity.demo.menu.springpathhorizontal.animation.ShrinkAnimationOut;
import com.lyyj.activity.demo.menu.springpathhorizontal.animation.SpringAnimation;
import com.lyyj.activity.demo.menu.springpathhorizontal.animation.ZoomAnimation;
import com.lyyj.activity.demo.menu.springpathhorizontal.utility.DeviceUtility;
 ...
 * @Version V1.0
 */
public class SpringPathHorizontalMainActivity extends Activity {
	...
	private int[] mainResources = {
			R.drawable.lyyj_menu_springpathhorizontal_bg_main_1,R.drawable.lyyj_menu_springpathhorizontal_bg_main_2,
			R.drawable.lyyj_menu_springpathhorizontal_bg_main_3,R.drawable.lyyj_menu_springpathhorizontal_bg_main_4,
			R.drawable.lyyj_menu_springpathhorizontal_bg_main_1,R.drawable.lyyj_menu_springpathhorizontal_bg_main_4};

	/** Called when the activity is first created. */
	@Override
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.lyyj_menu_springpathhorizontal_main_activity);
	...
	private void initViews(){
		...
		animRotateClockwise = AnimationUtils.loadAnimation(
				this,R.anim.lyyj_menu_springpathhorizontal_rotate_clockwise);
		animRotateAntiClockwise = AnimationUtils.loadAnimation(
				this,R.anim.lyyj_menu_springpathhorizontal_rotate_anticlockwise);
	...
	private class SpringMenuLauncher implements OnClickListener {
		...
		public void onClick(View v) {
			// TODO Auto-generated method stub
			SpringPathHorizontalMainActivity.this.startSpringMenuAnimations(v);
	...
	private void startSpringMenuAnimations(View view) {
		...
		shrinkOut1.setAnimationListener(new Animation.AnimationListener() {
			...
			public void onAnimationEnd(Animation animation) {
				// TODO Auto-generated method stub
				SpringPathHorizontalMainActivity.this.imageViewPlus.clearAnimation();
			}
