package com.lyyj.activity.demo.menu.residemenu;
...
public class ResideMenu extends FrameLayout{
    ...
    private void initViews(Context context){
        ...
        inflater.inflate(R.layout.lyyj_menu_residemenu_reside_menu_lib_residemenu, this);
    ...
    public void setShadowVisible(boolean isVisible){
        if (isVisible)
            imageViewShadow.setBackgroundResource(R.drawable.lyyj_menu_residemenu_reside_menu_lib_shadow);
        else
