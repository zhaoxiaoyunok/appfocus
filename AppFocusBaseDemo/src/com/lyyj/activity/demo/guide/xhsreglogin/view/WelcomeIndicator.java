package com.lyyj.activity.demo.guide.xhsreglogin.view;
...
public class WelcomeIndicator extends LinearLayout{
    ...
    public WelcomeIndicator(Context context, AttributeSet attrs) {
        ...
        bmpSelect= BitmapFactory.decodeResource(getResources(), R.drawable.lyyj_guide_xhsreglogin_welcome_indicator_point_select);
        bmpNomal= BitmapFactory.decodeResource(getResources(), R.drawable.lyyj_guide_xhsreglogin_welcome_indicator_point_nomal);
    }
