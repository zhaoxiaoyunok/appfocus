package com.lyyj.activity.demo.guide.xhsreglogin;
...
import com.lyyj.activity.demo.guide.xhsreglogin.fragment.outlayer.LoginAnimFragment;
import com.lyyj.activity.demo.guide.xhsreglogin.fragment.outlayer.WelcomAnimFragment;
import com.lyyj.activity.demo.guide.xhsreglogin.utils.DisplayUtil;
import com.lyyj.activity.demo.guide.xhsreglogin.view.ParentViewPager;
 ...
 */
public class XhsWelcomeActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lyyj_guide_xhsreglogin_activity_welcome);
        findView();
        setClick();
        init();
    }
    ...
    private void playLogoInAnim(){
        ...
        ObjectAnimator anim3 = ObjectAnimator.ofFloat(iv_logo, "y", mLogoY, DisplayUtil.dip2px(XhsWelcomeActivity.this, 15));
