...
import com.lyyj.activity.demo.guide.xhsreglogin.fragment.outlayer.loginlayer.LoginFragment;
import com.lyyj.activity.demo.guide.xhsreglogin.fragment.outlayer.loginlayer.RegisterFragment;
...
public class LoginAnimFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ViewGroup view = (ViewGroup) inflater.inflate(R.layout.lyyj_guide_xhsreglogin_fragment_welcomanim_login, null);
        ...
        mViewPager.setOnPageChangeListener(new ViewPager.SimpleOnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                if (position == 0) {
                    mLoginText.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, R.drawable.lyyj_guide_xhsreglogin_ic_triangle);
                    mRegisterText.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
                } else {
                    mLoginText.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
                    mRegisterText.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, R.drawable.lyyj_guide_xhsreglogin_ic_triangle);
                }
            }
        });
        return view;
