package com.lyyj.activity.demo.guide.xhsreglogin.fragment.outlayer.welcomelayer;
...
import com.lyyj.activity.demo.guide.xhsreglogin.fragment.base.LoginAnimImageBaseFragment;
import com.lyyj.activity.demo.guide.xhsreglogin.utils.DisplayUtil;
...
public class LoginAnimImageSecondFragment extends LoginAnimImageBaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ViewGroup view = (ViewGroup) inflater.inflate(R.layout.lyyj_guide_xhsreglogin_fragment_welcomanim_image_second, null);
        ...
        Bitmap bmpScroll = BitmapFactory.decodeResource(getResources(), R.drawable.lyyj_guide_xhsreglogin_welcomeanim_second_scrollbg);
        Bitmap bmpShield = BitmapFactory.decodeResource(getResources(), R.drawable.lyyj_guide_xhsreglogin_welcome_shield);
        Bitmap bmpGoods = BitmapFactory.decodeResource(getResources(), R.drawable.lyyj_guide_xhsreglogin_welcomeanim_second_goods);
        ...
        bmpBuysIng = bitmapScale(BitmapFactory.decodeResource(getResources(), R.drawable.lyyj_guide_xhsreglogin_welcomeanim_second_buging));
        bmpBuysed = bitmapScale(BitmapFactory.decodeResource(getResources(), R.drawable.lyyj_guide_xhsreglogin_welcomeanim_second_bugged));
