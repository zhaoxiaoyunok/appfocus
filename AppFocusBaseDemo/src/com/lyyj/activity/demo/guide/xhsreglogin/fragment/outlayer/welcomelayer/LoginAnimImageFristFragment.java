...
public class LoginAnimImageFristFragment extends LoginAnimImageBaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ViewGroup view = (ViewGroup) inflater.inflate(R.layout.lyyj_guide_xhsreglogin_fragment_welcomanim_image_frist, null);
        iv_scroll = (ImageView) view.findViewById(R.id.iv_scroll);
        tv_bg = (ImageView) view.findViewById(R.id.tv_bg);

        Bitmap bmpShield= BitmapFactory.decodeResource(getResources(), R.drawable.lyyj_guide_xhsreglogin_welcomeanim_phone);
        Bitmap bmpScroll= BitmapFactory.decodeResource(getResources(), R.drawable.lyyj_guide_xhsreglogin_welcomeanim_frist_scrollbg);
