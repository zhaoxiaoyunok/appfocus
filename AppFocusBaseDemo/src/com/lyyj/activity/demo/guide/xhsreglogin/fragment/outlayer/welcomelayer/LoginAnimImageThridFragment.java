...
public class LoginAnimImageThridFragment extends LoginAnimImageBaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ViewGroup view = (ViewGroup) inflater.inflate(R.layout.lyyj_guide_xhsreglogin_fragment_welcomanim_image_thrid, null);
        ...
        Bitmap bmpScroll= BitmapFactory.decodeResource(getResources(), R.drawable.lyyj_guide_xhsreglogin_welcomeanim_thrid_scrollbg);
        Bitmap bmpShield= BitmapFactory.decodeResource(getResources(), R.drawable.lyyj_guide_xhsreglogin_welcomeanim_thrid_shield);
        ...
        Bitmap bmpCare= bitmapScale(BitmapFactory.decodeResource(getResources(), R.drawable.lyyj_guide_xhsreglogin_welcomeanim_thrid_shield_care));
