package com.lyyj.activity.demo.guide.xhsreglogin.fragment.outlayer.loginlayer;
...
public class LoginFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.lyyj_guide_xhsreglogin_fragment_new_login, null);
