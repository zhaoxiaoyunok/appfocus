 ...
 */
package com.lyyj.activity.demo.guide.guidefourways.utils;
...
public class AnimationUtil {
	...
	public static void finishActivityAnimation(Context context) {
		...
		((Activity) context).overridePendingTransition(R.anim.lyyj_guide_fourways_zoom_enter,
				R.anim.lyyj_guide_fourways_zoom_exit);
	}
