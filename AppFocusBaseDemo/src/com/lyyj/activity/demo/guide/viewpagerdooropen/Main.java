...
public class Main extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lyyj_guide_viewpagerdooropen_main);        
        getWindow().setFeatureInt(Window.FEATURE_CUSTOM_TITLE, R.layout.lyyj_guide_viewpagerdooropen_title); 
        instance = this;
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
    	if (keyCode == KeyEvent.KEYCODE_BACK && event.getRepeatCount() == 0) {  //获取 back键
			...
			if(!menu_display){
				...
				layout = inflater.inflate(R.layout.lyyj_guide_viewpagerdooropen_main_menu, null);
