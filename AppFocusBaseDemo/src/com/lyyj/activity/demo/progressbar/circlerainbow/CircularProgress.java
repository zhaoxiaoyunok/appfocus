package com.lyyj.activity.demo.progressbar.circlerainbow;
...
public class CircularProgress extends View {
    ...
    public CircularProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CircularProgressRB, defStyleAttr, 0);
        mBorderWidth = a.getDimension(R.styleable.CircularProgressRB_borderWidthRB,
