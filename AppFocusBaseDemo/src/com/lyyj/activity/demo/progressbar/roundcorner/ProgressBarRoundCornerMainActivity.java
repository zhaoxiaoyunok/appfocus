...
package com.lyyj.activity.demo.progressbar.roundcorner;
...
public class ProgressBarRoundCornerMainActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lyyj_pb_roundcorner_activity_main);

        progressOne = (IconRoundCornerProgressBar) findViewById(R.id.progress_one);
        progressOne.setProgressColor(
                getResources().getColor(R.color.rccustom_progress_blue_progress),
                getResources().getColor(R.color.rccustom_progress_blue_progress_half)
        );
        progressOne.setHeaderColor(getResources().getColor(R.color.rccustom_progress_blue_header));
        progressOne.setBackgroundColor(getResources().getColor(R.color.rccustom_progress_background));
        ...
        progressTwo.setBackgroundColor(getResources().getColor(R.color.rccustom_progress_background));
    ...
    private void updateProgressTwoColor() {
        if(progress2 <= 3) {
            progressTwo.setProgressColor(getResources().getColor(R.color.rccustom_progress_red_progress));
        } else if(progress2 > 3 && progress2 <= 6) {
            progressTwo.setProgressColor(getResources().getColor(R.color.rccustom_progress_orange_progress));
        } else if(progress2 > 6) {
            progressTwo.setProgressColor(getResources().getColor(R.color.rccustom_progress_green_progress));
        }
    }
}
