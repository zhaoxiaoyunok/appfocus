...
public class IconRoundCornerProgressBar extends LinearLayout {
    ...
    public IconRoundCornerProgressBar(Context context, AttributeSet attrs) {
        ...
        if (!isInEditMode()) {
            ...
            inflater.inflate(R.layout.lyyj_pb_roundcorner_round_corner_with_icon_layout, this);
            setup(context, attrs);
    ...
    private void setup(Context context, AttributeSet attrs) {
        ...
        if (!isIconSetBeforeDraw) {
            int iconResource = (int) typedArray.getResourceId(R.styleable.RoundCornerProgress_rcIconSrc, R.drawable.lyyj_pb_roundcorner_round_corner_progress_icon);
