...
import com.lyyj.activity.demo.calendar.timessquare.CalendarPickerView;
import com.lyyj.activity.demo.calendar.timessquare.CalendarPickerView.SelectionMode;
...
public class SampleTimesSquareActivity extends AfActivity {
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    setAfContentView(R.layout.lyyj_calendar_times_square_sample_calendar_picker);
    AfTitleBar mAfTitleBar = this.getTitleBar();
    mAfTitleBar.setTitleText("timesSquare sample");
  ...
  private void initButtonListeners(final Calendar nextYear, final Calendar lastYear) {
    ...
    dialog.setOnClickListener(new OnClickListener() {
      @Override public void onClick(View view) {
        ...
        showCalendarInDialog(title, R.layout.lyyj_calendar_times_square_dialog);
    ...
    customized.setOnClickListener(new OnClickListener() {
      @Override public void onClick(View view) {
        showCalendarInDialog("Pimp my calendar!", R.layout.lyyj_calendar_times_square_dialog_customized);
        dialogView.init(lastYear.getTime(), nextYear.getTime())
            .withSelectedDate(new Date());
      }
    });
    ...
    rtl.setOnClickListener(new OnClickListener() {
      @Override public void onClick(View view) {
        showCalendarInDialog("I'm right-to-left!", R.layout.lyyj_calendar_times_square_dialog);
