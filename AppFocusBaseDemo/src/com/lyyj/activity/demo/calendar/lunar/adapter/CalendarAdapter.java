package com.lyyj.activity.demo.calendar.lunar.adapter;
...
import com.lyyj.activity.demo.calendar.lunar.data.DateInfo;
import com.lyyj.activity.demo.calendar.lunar.utils.DataUtils;
...
public class CalendarAdapter extends BaseAdapter {
	...
	LunarActivity activity;
	public CalendarAdapter(LunarActivity activity, List<DateInfo> list) {
	...
	public View getView(int position, View convertView, ViewGroup group) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.lyyj_calendar_lunar_gridview_item, null);
		...
		if (selectedPosition == position) {
			...
			convertView.setBackgroundResource(R.drawable.lyyj_calendar_lunar_item_bkg);
