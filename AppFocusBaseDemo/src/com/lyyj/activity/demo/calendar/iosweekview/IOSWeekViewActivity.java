package com.lyyj.activity.demo.calendar.iosweekview;
...
public class IOSWeekViewActivity extends Activity implements OnGestureListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.lyyj_calendar_iosweekview_activity_main);
	...
	private void addGridView() {
		...
		gridView.setOnTouchListener(new OnTouchListener() {
			...
			public boolean onTouch(View v, MotionEvent event) {
				return IOSWeekViewActivity.this.gestureDetector.onTouchEvent(event);
			}
		});
	...
	public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX,
		...
		if (e1.getX() - e2.getX() > 80) {
			...
			this.flipper1.setInAnimation(AnimationUtils.loadAnimation(this,
					R.anim.lyyj_calendar_iosweekview_push_left_in));
			this.flipper1.setOutAnimation(AnimationUtils.loadAnimation(this,
					R.anim.lyyj_calendar_iosweekview_push_left_out));
			...
			dateAdapter.setSeclection(selectPostion);
			this.flipper1.setInAnimation(AnimationUtils.loadAnimation(this,
					R.anim.lyyj_calendar_iosweekview_push_right_in));
			this.flipper1.setOutAnimation(AnimationUtils.loadAnimation(this,
					R.anim.lyyj_calendar_iosweekview_push_right_out));
