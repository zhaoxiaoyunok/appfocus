...
package com.lyyj.activity.demo.calendar.dateslider;
...
import com.lyyj.activity.demo.calendar.dateslider.labeler.Labeler;
...
public class ScrollLayout extends LinearLayout {
    ...
    public ScrollLayout(Context context, AttributeSet attrs) {
        ...
        rightShadow = getContext().getResources().getDrawable(R.drawable.lyyj_calendar_dateslider_right_shadow);
        leftShadow = getContext().getResources().getDrawable(R.drawable.lyyj_calendar_dateslider_left_shadow);
