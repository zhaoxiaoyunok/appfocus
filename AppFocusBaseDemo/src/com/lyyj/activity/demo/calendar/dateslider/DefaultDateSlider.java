...
public class DefaultDateSlider extends DateSlider {
	...
	public DefaultDateSlider(Context context, OnDateSetListener l, Calendar calendar, 
        ...
        super(context, R.layout.lyyj_calendar_dateslider_defaultdateslider, l, calendar, minTime, maxTime);
    }
	
    public DefaultDateSlider(Context context, OnDateSetListener l, Calendar calendar) {
        super(context, R.layout.lyyj_calendar_dateslider_defaultdateslider, l, calendar);
    }
}
