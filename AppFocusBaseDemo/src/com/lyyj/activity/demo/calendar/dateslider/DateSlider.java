...
import com.lyyj.activity.demo.calendar.dateslider.SliderContainer.OnTimeChangeListener;
...
//	private static String TAG = "DATESLIDER";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.getWindow().setFeatureInt(Window.FEATURE_CUSTOM_TITLE, R.layout.lyyj_calendar_dateslider_dialogtitle);
